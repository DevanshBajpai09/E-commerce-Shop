                ...
                <div>
                    ...
                    <span className={cn(i!==0 ? "lg:pl-9":"",'flex items-center px-6 py-4 text-sm font-medium')}>
                        <span className='flex shrink-0'>
                            <Image src={imgPath} alt='img' width={40} height={40} className={cn('flex h-20 w-20 object-contain items-center justify-center',{
                                'border-none':isCompleted,
                                'border-zinc-700':isCurrent,
                            })}/>                        
                            </span>
                            <span className='ml-4 h-full mt-0.5 flex min-w-0 flex-col justify-center'>
                                <span className={cn('text-sm font-semibold text-zinc-700',{'text-primary':isCompleted , 'text-zinc-700':isCurrent})}>{steps.name}</span>
                                <span className='text-sm text-zinc-500'>{steps.description}</span>
